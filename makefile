...
#AVRDUDE_WRITE_FUSE = -U lfuse:w:0x04:m #run with 8 Mhz clock

#AVRDUDE_WRITE_FUSE = -U lfuse:w:0x21:m #run with 1 Mhz clock #default clock mode

#AVRDUDE_WRITE_FUSE = -U lfuse:w:0x01:m #run with 1 Mhz clock no start up time

# AVRDUDE_FLAGS += -U lfuse:r:fuses:h
# AVRDUDE_FLAGS += -U lfuse:w:0x6a:m # Use default clock.
